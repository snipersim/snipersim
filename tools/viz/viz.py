...
if __name__ == '__main__':
  ...
  if outputdir != HOME:
    ...
    os.system('cd "%s"; tar c index.html rickshaw/ levels/level2/*html levels/level3/*html css/ levels/level2/css levels/level2/javascript/ levels/level3/javascript | tar x -C %s' % (HOME, outputdir))
  if verbose:
