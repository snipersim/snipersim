...
class NucaCache
{
   private:
      ...
      SubsecondTime accessDataArray(Cache::access_t access, SubsecondTime t_start);
   ...
   public:
      ...
      boost::tuple<SubsecondTime, HitWhere::where_t> read(IntPtr address, Byte* data_buf, SubsecondTime now);
