...
CacheSet::CacheSet(CacheBase::cache_t cache_type,
                   UInt32 associativity, UInt32 blocksize, bool is_tlb_set) : m_associativity(associativity), m_blocksize(blocksize), m_is_tlb_set(is_tlb_set), inserts(0), evictions(0), invalidations(0)
{
