...
void CacheSetPLRU::updateReplacementIndex(UInt32 accessed_index)
{
   if (m_associativity == 4)
   {
      if (accessed_index == 0)
      ...
      else if (accessed_index == 1)
      {
         b[0] = 1;
         b[1] = 0;
      }
      else if (accessed_index == 2)
      {
         b[0] = 0;
         b[2] = 1;
      }
      else if (accessed_index == 3)
      {
         b[0] = 0;
         b[2] = 0;
      }
   ...
   else if (m_associativity == 8)
   {
      ...
      else if (accessed_index == 4)
      {
         b[0] = 0;
         b[4] = 1;
         b[5] = 1;
      }
      else if (accessed_index == 5)
      {
         b[0] = 0;
         b[4] = 1;
         b[5] = 0;
      }
      else if (accessed_index == 6)
      {
         b[0] = 0;
         b[4] = 0;
         b[6] = 1;
      }
      else if (accessed_index == 7)
      {
         b[0] = 0;
         b[4] = 0;
         b[6] = 0;
