...
namespace CacheEfficiencyTracker
{
   ...
   typedef void (*CallbackNotifyAccess)(UInt64 user, UInt64 owner, HitWhere::where_t hit_where);
   ...
   struct Callbacks
   {
      ...
      void call_notify_access(UInt64 owner, HitWhere::where_t hit_where) const
      { notify_access_func(user_arg, owner, hit_where); }
